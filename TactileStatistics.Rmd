...
SaveSixPlots <- function(Metric = "NULL", filetype = ".pdf") {
    ...
    ggsave(filename = title1, plot = plot1, path = Metric, width = width, height = height, dpi = dpi, units = units)
    ggsave(filename = title2, plot = plot2, path = Metric, width = width, height = height, dpi = dpi, units = units)
    ggsave(filename = title3, plot = plot3, path = Metric, width = width, height = height, dpi = dpi, units = units)
    ggsave(filename = title4, plot = plot4, path = Metric, width = width, height = height, dpi = dpi, units = units)
    ggsave(filename = title5, plot = plot5, path = Metric, width = width, height = height, dpi = dpi, units = units)
    ggsave(filename = title6, plot = plot6, path = Metric, width = width, height = height, dpi = dpi, units = units)
...
ggsave(filename = "GenderCondition.pdf", plot = GenderCondition, path = Metric, width = width, height = height, dpi = dpi, units = units)
ggsave(filename = "AgeCondition.pdf", plot = AgeCondition, path = Metric, width = width, height = height, dpi = dpi, units = units)
ggsave(filename = "ComputerCondition.pdf", plot = ComputerCondition, path = Metric, width = width, height = height, dpi = dpi, units = units)
ggsave(filename = "DrivingCondition.pdf", plot = DrivingCondition, path = Metric, width = width, height = height, dpi = dpi, units = units)
ggsave(filename = "SimulatorYesNoExperienceCondition.pdf", plot = SimulatorYesNoExperienceCondition, path = Metric, width = width, height = height, dpi = dpi, units = units)
ggsave(filename = "CarGamesCondition.pdf", plot = CarGamesCondition, path = Metric, width = width, height = height, dpi = dpi, units = units)
ggsave(filename = "AutomaticExperienceCondition.pdf", plot = AutomaticExperienceCondition, path = Metric, width = width, height = height, dpi = dpi, units = units)
ggsave(filename = "CarSimulatorExperienceCondition.pdf", plot = CarSimulatorExperienceCondition, path = Metric, width = width, height = height, dpi = dpi, units = units)
```
...
```{r}
SUSBox <- ggplot(dataFrame, aes(x = Condition, y = SUS, fill = Condition)) +
    geom_boxplot() +
    scale_fill_brewer(palette = "Set1") +
    labs(x = "Condition", y = "SUS score", title = "SUS score grouped by condition") +
    theme(plot.title = element_text(hjust = 0.5))
SARTBox <- ggplot(dataFrame, aes(x = Condition, y = SART, fill = Condition)) +
    geom_boxplot() +
    scale_fill_brewer(palette = "Set1") +
    labs(x = "Condition", y = "SART score", title = "SART score grouped by condition") +
    theme(plot.title = element_text(hjust = 0.5))
TotalGlanceTimeBox <- ggplot(dataFrame, aes(x = Condition, y = TotalGlanceTime, fill = Condition)) +
    geom_boxplot() +
    scale_fill_brewer(palette = "Set1") +
    labs(x = "Condition", y = "Glance time", title = "Glance time grouped by condition") +
    theme(plot.title = element_text(hjust = 0.5))
...
```{r}
TotalGlances <- ggplot(data = dataFrame, mapping = aes(x = Condition, y = TotalGlances, fill = Condition))
TotalGlances <- TotalGlances + geom_col(col = "black") + scale_y_continuous(name = "Glances") + ggtitle("Total Glances")

TotalCrash <- ggplot(data = dataFrame, mapping = aes(x = Condition, y = TotalCrash, fill = Condition))
TotalCrash <- TotalCrash + geom_col(col = "black") + scale_y_continuous(name = "Crashes", breaks = c(0:15)) + ggtitle("Total Crash")

TotalLaneBreaks <- ggplot(data = dataFrame, mapping = aes(x = Condition, y = LaneBreaks, fill = Condition))
TotalLaneBreaks <- TotalLaneBreaks + geom_col(col = "black") + scale_y_continuous(name = "Lane breaks") + ggtitle("Total Lane Breaks")
...
Palette <- "Set1"
TotalGlances <- TotalGlances + scale_fill_brewer(palette = Palette)
TotalCrash <- TotalCrash + scale_fill_brewer(palette = Palette)
TotalLaneBreaks <- TotalLaneBreaks + scale_fill_brewer(palette = Palette)
```
```{r}
#dev.new(width = 5, height = 4, noRStudioGD = TRUE)
scale <- 0.84
...
dpi <- 400
units <- "in"
Metric <- "Raw Data Visualized"
dir.create(Metric)

ggsave(filename = "SUSBox.pdf", plot = SUSBox, path = Metric, width = width, height = height, dpi = dpi, units = units)
ggsave(filename = "SARTBox.pdf", plot = SARTBox, path = Metric, width = width, height = height, dpi = dpi, units = units)
ggsave(filename = "TotalGlanceTimeBox.pdf", plot = TotalGlanceTimeBox, path = Metric, width = width, height = height, dpi = dpi, units = units)
ggsave(filename = "TotalGlancesBar.pdf", plot = TotalGlances, path = Metric, width = width, height = height, dpi = dpi, units = units)
ggsave(filename = "TotalCrashBar.pdf", plot = TotalCrash, path = Metric, width = width, height = height, dpi = dpi, units = units)
ggsave(filename = "TotalLaneBreaksBar.pdf", plot = TotalLaneBreaks, path = Metric, width = width, height = height, dpi = dpi, units = units)

ggsave(filename = "SUSBox.png", plot = SUSBox, path = Metric, width = width, height = height, dpi = dpi, units = units)
ggsave(filename = "SARTBox.png", plot = SARTBox, path = Metric, width = width, height = height, dpi = dpi, units = units)
ggsave(filename = "TotalGlanceTimeBox.png", plot = TotalGlanceTimeBox, path = Metric, width = width, height = height, dpi = dpi, units = units)
ggsave(filename = "TotalGlancesBar.png", plot = TotalGlances, path = Metric, width = width, height = height, dpi = dpi, units = units)
ggsave(filename = "TotalCrashBar.png", plot = TotalCrash, path = Metric, width = width, height = height, dpi = dpi, units = units)
ggsave(filename = "TotalLaneBreaksBar.png", plot = TotalLaneBreaks, path = Metric, width = width, height = height, dpi = dpi, units = units)
```
...
TotalGlanceTime
  ...
  Total Lane breaks
```{r}
HistSUS <- ggplot(dataFrame, aes(x=SUS,fill=Condition, color=Condition)) +
  geom_histogram(alpha=0.8, position="dodge") + scale_x_continuous(breaks = seq(from = 45, to = 100, by = 5))

HistSART<- ggplot(dataFrame, aes(x=SART,fill=Condition, color=Condition)) +
  geom_histogram(alpha=0.8, position="dodge") + scale_x_continuous(breaks = seq(from = 0, to = 30, by = 2))

HistTotalGlanceTime<- ggplot(dataFrame, aes(x=TotalGlanceTime,fill=Condition, color=Condition)) +
  geom_histogram(alpha=0.8, position="dodge") + scale_x_continuous(breaks = seq(from = 0, to = 600, by = 4))

HistTotalGlances<- ggplot(dataFrame, aes(x=TotalGlances,fill=Condition, color=Condition)) +
  geom_histogram(alpha=0.8, position="dodge") + scale_x_continuous(breaks = seq(from = 0, to = 600, by = 5))

HistTotalCrash<- ggplot(dataFrame, aes(x=TotalCrash,fill=Condition, color=Condition)) +
  geom_histogram(alpha=0.8, position="dodge") + scale_x_continuous(breaks = seq(from = 0, to = 600, by = 1))

HistTotalLaneBreaks<- ggplot(dataFrame, aes(x=LaneBreaks,fill=Condition, color=Condition)) +
  geom_histogram(alpha=0.8, position="dodge") + scale_x_continuous(breaks = seq(from = 0, to = 600, by = 1))
...
ggsave(filename = "SUSHist.pdf", plot = HistSUS, path = Metric, width = width, height = height, dpi = dpi, units = units)
ggsave(filename = "SARTHist.pdf", plot = HistSART, path = Metric, width = width, height = height, dpi = dpi, units = units)
ggsave(filename = "TotalGlanceTimeHist.pdf", plot = HistTotalGlanceTime, path = Metric, width = width, height = height, dpi = dpi, units = units)
ggsave(filename = "TotalGlancesHist.pdf", plot = HistTotalGlances, path = Metric, width = width, height = height, dpi = dpi, units = units)
ggsave(filename = "TotalCrashHist.pdf", plot = HistTotalCrash, path = Metric, width = width, height = height, dpi = dpi, units = units)
ggsave(filename = "TotalLaneBreaksHist.pdf", plot = HistTotalLaneBreaks, path = Metric, width = width, height = height, dpi = dpi, units = units)

ggsave(filename = "SUSHist.png", plot = HistSUS, path = Metric, width = width, height = height, dpi = dpi, units = units)
ggsave(filename = "SARTHist.png", plot = HistSART, path = Metric, width = width, height = height, dpi = dpi, units = units)
ggsave(filename = "TotalGlanceTimeHist.png", plot = HistTotalGlanceTime, path = Metric, width = width, height = height, dpi = dpi, units = units)
ggsave(filename = "TotalGlancesHist.png", plot = HistTotalGlances, path = Metric, width = width, height = height, dpi = dpi, units = units)
ggsave(filename = "TotalCrashBarHist.png", plot = HistTotalCrash, path = Metric, width = width, height = height, dpi = dpi, units = units)
ggsave(filename = "TotalLaneBreaksBarHist.png", plot = HistTotalLaneBreaks, path = Metric, width = width, height = height, dpi = dpi, units = units)
```
...
SARTDistribution <- ggplot(data = dataFrame, mapping = aes(x = SART, fill = Condition, alpha = alpha))
SARTDistribution <- SARTDistribution + geom_density() + ggtitle("SART distribution") + scale_fill_brewer(palette = Palette)
...
plot1 <- SUSDistribution + guides(alpha = FALSE)
plot2 <- SARTDistribution + guides(alpha = FALSE)
plot3 <- CrashDistribution + guides(alpha = FALSE)
plot4 <- LaneBreakDistribution + guides(alpha = FALSE)
plot5 <- GlancesDistribution + guides(alpha = FALSE)
plot6 <- GlanceTimeDistribution + guides(alpha = FALSE)
...
ggsave(filename = "SUSDistribution.pdf", plot = plot1, path = Metric, width = width, height = height, dpi = dpi, units = units)
ggsave(filename = "SARTDistribution.pdf", plot = plot2, path = Metric, width = width, height = height, dpi = dpi, units = units)
ggsave(filename = "CrashDistribution.pdf", plot = plot3, path = Metric, width = width, height = height, dpi = dpi, units = units)
ggsave(filename = "LaneBreaksDistribution.pdf", plot = plot4, path = Metric, width = width, height = height, dpi = dpi, units = units)
ggsave(filename = "GlancesDistribution.pdf", plot = plot5, path = Metric, width = width, height = height, dpi = dpi, units = units)
ggsave(filename = "GlanceTimeDistribution.pdf", plot = plot6, path = Metric, width = width, height = height, dpi = dpi, units = units)
```
...
glanceTimeqqPlot <- ggqqplot(residuals(glanceTimeModel))
shapiro_test(residuals(glanceTimeModel))

ggsave(filename = "glanceTimeqqPlot.pdf", plot = glanceTimeqqPlot, path = dir, width = width, height = height, dpi = dpi, units = units)
...
glanceCountqqPlot <- ggqqplot(residuals(glanceCountModel))
shapiro_test(residuals(glanceCountModel))

ggsave(filename = "glanceCountqqPlot.pdf", plot = glanceCountqqPlot, path = dir, width = width, height = height, dpi = dpi, units = units)
...
crashCountqqPlot <- ggqqplot(residuals(crashDataModel))
shapiro_test(residuals(crashDataModel))

ggsave(filename = "crashCountqqPlot.pdf", plot = crashCountqqPlot, path = dir, width = width, height = height, dpi = dpi, units = units)
...
laneData %>%
    group_by(Condition) %>%
    summarise_at(vars(LaneBreaks), list(name = mean))
...
summary(laneDataModel)
plot(laneDataModel)
laneBreakqqPlot <- ggqqplot(residuals(laneDataModel))
laneBreakqqPlot

ggsave(filename = "laneBreakqqPlot.pdf", plot = laneBreakqqPlot, path = dir, width = width, height = height, dpi = dpi, units = units)
...
susqqPlot <- ggqqplot(residuals(susDataModel))
shapiro_test(residuals(susDataModel))

ggsave(filename = "susqqPlot.pdf", plot = susqqPlot, path = dir, width = width, height = height, dpi = dpi, units = units)
...
sartqqPlot <- ggqqplot(residuals(sartDataModel))
shapiro_test(residuals(sartDataModel))

ggsave(filename = "sartqqPlot.pdf", plot = sartqqPlot, path = dir, width = width, height = height, dpi = dpi, units = units)
...
singleGlanceBox <- ggplot(taskLongDataFrame, aes(x = factor(Task_nr), y = Single_Glance_duration, fill = factor(Task_nr))) +
    ...
    labs(x = "Task Nr", y = "Single glance time [s]", fill = "Task Nr", title = "Single glance time grouped by task") +
    theme(plot.title = element_text(hjust = 0.5)) +
...
glanceTaskBox <- ggplot(taskShortDataFrame, aes(x = Task_nr, y = Total_glance_duration_pr_task, group = Task_nr, fill = factor(Task_nr))) +
    ...
    scale_fill_brewer(palette = "Spectral") +
    labs(x = "Task Nr", y = "Total glance time [s]", fill = "Task Nr", title = "Total glance time grouped by task number") +
    theme(plot.title = element_text(hjust = 0.5)) +
...
glanceTaskqqPlot <- ggqqplot(residuals(glanceTaskModel))
glanceTaskqqPlot
plot(glanceTaskModel)
shapiro_test(residuals(glanceTaskModel))

ggplot(glanceTaskModel, aes(x = residuals(glanceTaskModel))) +
    geom_density()
...
```{r, echo=FALSE}
dir <- "TaskAnalysis"
ggsave(filename = "glanceTaskQQplot.pdf", plot = glanceTaskqqPlot, path = dir, width = width, height = height, dpi = dpi, units = units)
```
...
```{r}
taskLongDataFrame$Single_Glance_duration <- log10(taskLongDataFrame$Single_Glance_duration+1)

taskShortDataFrame$Total_glance_duration_pr_task <- log10(taskShortDataFrame$Total_glance_duration_pr_task+1)
