...
HistSUS <- ggplot(dataFrame, aes(x=SUS,fill=Condition, color=Condition)) +
  geom_histogram(alpha=0.8, position="dodge") + scale_x_continuous(breaks = seq(from = 45, to = 100, by = 2))
...
HistTotalGlanceTime<- ggplot(dataFrame, aes(x=TotalGlanceTime,fill=Condition, color=Condition)) +
  geom_histogram(alpha=0.8, position="dodge") + scale_x_continuous(breaks = seq(from = 0, to = 600, by = 2))
...
HistSUS + scale_fill_brewer(palette = Palette)
HistSART + scale_fill_brewer(palette = Palette)
HistTotalGlanceTime + scale_fill_brewer(palette = Palette)
HistTotalGlances + scale_fill_brewer(palette = Palette)
HistTotalCrash + scale_fill_brewer(palette = Palette)
HistTotalLaneBreaks + scale_fill_brewer(palette = Palette)
```
```{r}
scale <- 0.84
width <- 6*scale
